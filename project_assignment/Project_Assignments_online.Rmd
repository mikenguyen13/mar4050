...
[comment]: <> (remember to change assignment 6 to be 10, and 12 to 40)
...
This PA is highly similar to our [first case discussion](https://github.com/mikenguyen13/mar4050_F21/raw/master/case_discussion/CE1%20%20discussion.docx).
...
4.  a completed copy of Questionnaire Worksheet A ([WorksheetA template](https://github.com/mikenguyen13/mar4050_F21/raw/master/project_assignment/questionnaire/8-Qnaire%20worksheet%20A.xls))

5.  a completed copy of Questionnaire Worksheet B ([WorksheetB template](https://github.com/mikenguyen13/mar4050_F21/raw/master/project_assignment/questionnaire/8-Qnaire%20worksheet%20B.xls))
...
Type the data analysis plan for your project that you develop in class into a formal document, using the [Data Analysis Plan template](https://github.com/mikenguyen13/mar4050_F21/raw/master/project_assignment/Data%20Anal%20Plan%20wkst.xlsx) and the [template](https://github.com/mikenguyen13/mar4050_F21/raw/master/project_assignment/data%20analysis%20plan%20grid.xlsx). [Include at least one group comparison analysis in your data analysis plan]{.ul}. You can use this [Qualtrics guide](https://github.com/mikenguyen13/mar4050_F21/raw/master/project_assignment/differences%20RQ%20analysis%20on%20Qualtrics.docx) for the group comparison research questions. You don't need to do the analysis yet, you only need to plan for the analysis.
...
For example, you are evaluated to have contributed 60% to the project based on the mid-term evaluation. However, you try to make it up and in the final evaluation, your team evaluates you to have contributed 100% to the project. And the instructor assigns 30 points to your group. Then your score will be

$$
(60\% \times \frac{1}{3} + 100 \% \times \frac{2}{3}) \times 30 = 26
$$

Moreover, this evaluation is also used in conjunction with the final evaluation to assess your professionalism. If there is evidence that you did not contribute and slack off, your professionalism point will be 0 (as discussed and mentioned in the syllabus).
...
2.  You can use the lecture slides on [Descriptive Statistics](https://github.com/mikenguyen13/mar4050_F21/raw/master/lectures/9/1_Descriptive%20Statistics.pptx), and [Data Analysis Plan](https://github.com/mikenguyen13/mar4050_F21/raw/master/lectures/9/2_Data%20Analysis%20Plan.pptx), and worksheets on [cross-tab](https://github.com/mikenguyen13/mar4050_F21/raw/master/lectures/9/Cross-tab%20worksheet.xlsx) and [descriptive](https://github.com/mikenguyen13/mar4050_F21/raw/master/lectures/9/descriptive.xlsx) for the difference questions bar-charts and other statistics.

3.  You can use the [cheat sheet excel sheet](https://github.com/mikenguyen13/mar4050_F21/raw/master/regression%20materials/2-Excel%20help%20sheet.docx) when you do the actual analysis.
...
In this assignment, you will evaluate your own performance throughout the project and that of other members of your group on the major project assignments completed so far. Click this [link](https://missouri.qualtrics.com/jfe/form/SV_cYYVV4ICwqR4mMK) to complete your evaluation. If this form is not submitted, you may receive an incomplete grade for the course.
...
Moreover, this evaluation is also used in conjunction with the mid-semester evaluation to assess your professionalism. If there is evidence that you did not contribute and slack off, your professionalism point will be 0 (as discussed and mentioned in the syllabus).
