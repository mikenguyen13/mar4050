...
Class Hours: 8 AM - 9:15 AM (Monday, Wednesday)

Classroom: CORNELL HALL 131

Office Hours: 9:30 AM - 10:30 AM (Monday, Wednesday) or [by appointment](https://calendly.com/mikenguyenbio)
...
This course has been constructed based on previous notes by professor Marsha Richins, and Frank Lin
...
|--------------------------------------|--------|
| Exam (2)                             | 400    |
| Group Term Project Assignments       | 240    |
| Case Discussion                      | 100    |
| Attendance                           | 50     |
| Participation                        | 50     |
| Professionalism                      | 10     |
| Qualtrics Homework                   | 50     |
| Individual Assignments (Weekly Quiz) | 100    |
| Total                                | 1000   |
...
-   Everyone is allowed to have **two** absences without questions asked. After that, each absence will cost you 50% of the attendance score unless excused by the instructor. Thus, **on your fourth absence**, all your attendance points will be gone.

-   iClicker attendance will be run automatically from 7:55 AM to 8:10 AM (UTC-06:00) Central Time (US & Canada) on class days.

-   For example, when you miss two classes, your attendance won't be affected. when you miss the third class, your attendance point is now only 20. When you miss the fourth class, you will receive 0 in your attendance point.
...
-   Students are expected to act in a professional manner during the class. If over half of your group members rate your performance as poor, professionalism point will automatically be 0. Professionalism includes being on time, being courteous to class members and the instructor, being reliable and conscientious when working on group projects, and other aspects of behavior normally expected of students or employees.
...
-   [Individual Assignment (Weekly Quiz)](#individual-assignment-weekly-quiz)
-   [Discussion Cases]
...
-   Each week you will have to complete a quiz on Canvas that is open after Wednesday class (9:30 AM) and is due on Sunday evening (11:59 PM). Students can view correct answers after the due date.
...
-   There will be 10 questions to be completed in 60 minutes.
...
-   These questions are randomly selected from a test bank. Hence, no two quizzes will be the same to prevent students from cheating. And 2 attempts from the students will be different as well.

-   Weekly quiz only goes up until week 12, which means you will only need to do 12 quizzes

-   Only the 10 quizzes with highest scores will be taken as your individual assignment grade. Since 2 lowest quizzes will given as your bonus/ extra credits, **no extensions whatever will be granted**.
...
-   [Case Discussion Document](https://github.com/mikenguyen13/mar4050_F21/raw/master/case_discussion/case_discussion.pdf)
...
-   ***Project Assignments*** (PA) are described in a separate document tilted "[Project Assignment](https://github.com/mikenguyen13/mar4050_F21/raw/master/project_assignment/Project_Assignments_online.pdf)". They are to be completed by group members and turned in on the due dates shown. To be considered, any requests to re-grade an assignment must be made within **one week after the grade has been posted on Canvas.**
-   [Sample term project report](https://github.com/mikenguyen13/mar4050_F21/tree/master/project_assignment/written_report)
...
[This assignment](https://github.com/mikenguyen13/mar4050_F21/raw/master/Qualtrics%20assign.docx) helps you familiarize yourself with Qualtrics, which will aid you in preparing your questionnaire for the group project.
...
+:====:+==========+===================================================+====================================+=====================+
| 1    | Aug 23   | Course Intro                                      |                                    | 1                   |
|      |          |                                                   |                                    |                     |
|      |          | Problem Analysis                                  |                                    |                     |
|      |          |                                                   |                                    |                     |
|      |          | Case Discussion                                   |                                    |                     |
+------+----------+---------------------------------------------------+------------------------------------+---------------------+
|      | Aug 25   | The Research Process                              | PA \#1 (end of the day)            | 2, 3                |
|      |          |                                                   |                                    |                     |
|      |          | Problem Definition                                | Quiz 1 (Sunday)                    |                     |
+------+----------+---------------------------------------------------+------------------------------------+---------------------+
| 2    | Aug 30   | Intro to Project                                  | PA \#2 (end of the day)            |                     |
+------+----------+---------------------------------------------------+------------------------------------+---------------------+
|      | Sep 1    | Research Designs                                  | CD \#1 (Sunday)                    | 4                   |
|      |          |                                                   |                                    |                     |
|      |          |                                                   | Quiz 2 (Sunday)                    |                     |
+------+----------+---------------------------------------------------+------------------------------------+---------------------+
| 3    | Sep 6    | Labor Day                                         |                                    |                     |
+------+----------+---------------------------------------------------+------------------------------------+---------------------+
|      | Sep 8    | Information Systems, Dashboards, & Data Analytics | CD \#2 (Sunday)                    | 5, 6                |
|      |          |                                                   |                                    |                     |
|      |          |                                                   | PA \#3 (Sunday)                    |                     |
|      |          |                                                   |                                    |                     |
|      |          |                                                   | Quiz 3 (Sunday)                    |                     |
+------+----------+---------------------------------------------------+------------------------------------+---------------------+
| 4    | Sep 13   | Project Meeting                                   |                                    |                     |
+------+----------+---------------------------------------------------+------------------------------------+---------------------+
|      | Sep 15   | Secondary & Syndicated Data                       | CD \#3 (Sunday)                    | 7, 8                |
|      |          |                                                   |                                    |                     |
|      |          | Experimentation                                   | PA \# 3.5 revision (Sunday)        |                     |
|      |          |                                                   |                                    |                     |
|      |          | Project Meeting                                   | Quiz 4 (Sunday)                    |                     |
+------+----------+---------------------------------------------------+------------------------------------+---------------------+
| 5    | Sep 20   | Survey Research                                   | Qualtrics homework published       | 9, 10, 11           |
+------+----------+---------------------------------------------------+------------------------------------+---------------------+
|      | Sep 22   | Measurement                                       | CD \#4 (Sunday)                    | 12                  |
|      |          |                                                   |                                    |                     |
|      |          | Questionnaire Design                              | Quiz 5 (Sunday)                    |                     |
|      |          |                                                   |                                    |                     |
|      |          |                                                   | Qualtrics homework (Sunday)        |                     |
+------+----------+---------------------------------------------------+------------------------------------+---------------------+
| 6    | Sep 27   | Questionnaire Design II                           | PA \#4                             | 13                  |
+------+----------+---------------------------------------------------+------------------------------------+---------------------+
|      | Sep 29   | Questionnaire Analysis                            | CD \#5 (Sunday)                    |                     |
|      |          |                                                   |                                    |                     |
|      |          |                                                   | Quiz 6 (Sunday)                    |                     |
+------+----------+---------------------------------------------------+------------------------------------+---------------------+
| 7    | Oct 4    | Sampling                                          | PA \# 4.5 (revision)               |                     |
|      |          |                                                   |                                    |                     |
|      |          | Data Preparation                                  |                                    |                     |
+------+----------+---------------------------------------------------+------------------------------------+---------------------+
|      | Oct 6    | Project Meetings                                  | PA \#5 (strongly suggest to begin) | 14, 15              |
|      |          |                                                   |                                    |                     |
|      |          |                                                   | CD \#6 (Sunday)                    |                     |
|      |          |                                                   |                                    |                     |
|      |          |                                                   | Quiz 7 (Sunday)                    |                     |
...
| 8    | Oct 11   | **First Exam**                                    |                                    |                     |
+------+----------+---------------------------------------------------+------------------------------------+---------------------+
|      | Oct 13   | Work Day (collecting data)                        | PA \#5 (Sunday)                    | 16                  |
|      |          |                                                   |                                    |                     |
|      |          |                                                   | Quiz 8 (Sunday)                    |                     |
+------+----------+---------------------------------------------------+------------------------------------+---------------------+
| 9    | Oct 18   | Descriptive Statistics                            |                                    | 12                  |
+------+----------+---------------------------------------------------+------------------------------------+---------------------+
|      | Oct 20   | Data Analysis Plans                               | PA \#6 (Sunday)                    |                     |
|      |          |                                                   |                                    |                     |
|      |          |                                                   | Quiz 9 (Sunday)                    |                     |
+------+----------+---------------------------------------------------+------------------------------------+---------------------+
| 10   | Oct 25   | Data Analysis                                     |                                    |                     |
+------+----------+---------------------------------------------------+------------------------------------+---------------------+
|      | Oct 27   | Visualizing and Reporting Data                    | PA \#7 (Sunday)                    | 20                  |
|      |          |                                                   |                                    |                     |
|      |          |                                                   | Quiz 10 (Sunday)                   |                     |
+------+----------+---------------------------------------------------+------------------------------------+---------------------+
| 11   | Nov 1    | Correlation                                       |                                    | 17                  |
|      |          |                                                   |                                    |                     |
|      |          | Simple Regression                                 |                                    |                     |
+------+----------+---------------------------------------------------+------------------------------------+---------------------+
|      | Nov 3    | Simple Regression (continued)                     | Quiz 11 (Sunday)                   |                     |
+------+----------+---------------------------------------------------+------------------------------------+---------------------+
| 12   | Nov 8    | Multiple Regression Basics                        |                                    | 18                  |
+------+----------+---------------------------------------------------+------------------------------------+---------------------+
|      | Nov 10   | Multiple Regression Applications                  | Quiz 12 (Sunday)                   |                     |
|      |          |                                                   |                                    |                     |
|      |          |                                                   | PA \#8 (Sunday)                    |                     |
|      |          |                                                   |                                    |                     |
|      |          |                                                   | PA \#9 (optional) (end of the day) |                     |
+------+----------+---------------------------------------------------+------------------------------------+---------------------+
| 13   | Nov 15   | Project Meeting (optional)                        |                                    |                     |
+------+----------+---------------------------------------------------+------------------------------------+---------------------+
|      | Nov 17   | Presentations                                     | 3 presentations                    |                     |
|      |          |                                                   |                                    |                     |
|      |          |                                                   | PA \#10 (due the day before)       |                     |
+------+----------+---------------------------------------------------+------------------------------------+---------------------+
| 14   |          | Thanksgiving Break                                |                                    |                     |
+------+----------+---------------------------------------------------+------------------------------------+---------------------+
|      | Nov 29   | Presentations                                     | 3 presentations                    |                     |
|      |          |                                                   |                                    |                     |
|      |          |                                                   | PA \#10 (the day before)           |                     |
|      |          |                                                   |                                    |                     |
|      |          |                                                   | PA \#11                            |                     |
+------+----------+---------------------------------------------------+------------------------------------+---------------------+
| 15   | Dec 1    | Review for Exam                                   |                                    |                     |
+------+----------+---------------------------------------------------+------------------------------------+---------------------+
|      | Dec 6    | **Second Exam**                                   |                                    |                     |
+------+----------+---------------------------------------------------+------------------------------------+---------------------+
| 16   | Dec 8    | Project Checkup                                   |                                    |                     |
+------+----------+---------------------------------------------------+------------------------------------+---------------------+
|      | Dec 13   | Project Report Due                                | PA \#12 (end of the day)           |                     |
|      |          |                                                   |                                    |                     |
